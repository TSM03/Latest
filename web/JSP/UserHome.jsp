...
<body>              
    ...
    <a href="JSP/GuestHome.jsp"><h2 style="font-weight: bolder; font-size: 3rem; color: black;">GLOWY DAYS</h2></a>
    <div class="navbar">
    ...
    <section class="footer">
        <div class="box-container">
          ...
          <div class="box">
            <h3>Quick Links</h3>
            <a href="UserHome.jsp"><i class="fas fa-angle-right"></i> Home</a>
